  ...
  section.flex.m-4.justify-center.items-center
    form.bg-gray-50.shadow-xl.rounded-lg.p-4.w-full(class="md:p-8")
      ...
      .flex.place-items-center
        button.flex.justify-center.items-center.place-items-center.border.border-blue-500.bg-blue-500.rounded-md.px-4.py-2.transition.duration-500.ease.select.w-full(@click='onClick', :disabled="selectedOrigin === '' || selectedDestiny === ''", type='button', class='hover:bg-blue-600 focus:shadow-outline enabled:hover:cursor-pointer disabled:bg-blue-500')
